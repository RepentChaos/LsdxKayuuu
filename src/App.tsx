            ...
            <section>
              ...
              <div className="grid grid-cols-1 gap-4">
                {(isLSD ? [
                  ...
                  { name: "Domínio do Caos Estruturado", description: "Lsd não só criou o Chaos - Xaoc, mas o transformou em um movimento organizado que se expandiu para Telegram e fóruns underground. Seus membros executavam operações coordenadas de vazamentos e ataques, enquanto ele mantinha o controle sem ser rastreado. Enquanto outros grupos caíam, o Chaos prosperou como um raro exemplo de caos metódico na web, graças à estratégia implacável de Lsd.", power: "87%" },
                  { name: "Domínio da Manipulação e Engenharia Social em Larga Escala", description: "Lsd não age apenas com tecnologia—sua habilidade em manipulação permitiu que ele mantivesse lealdade absoluta de seus seguidores, mesmo após escândalos e prisões. Ele usou doxxing, táticas psicológicas e controle de informação para manter seu grupo ativo e temido, mesmo estando afastado da internet atualmente.", power: "92%" }
                ] : [
